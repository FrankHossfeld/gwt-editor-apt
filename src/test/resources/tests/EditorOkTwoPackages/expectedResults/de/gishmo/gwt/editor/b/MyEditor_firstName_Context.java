...
public class MyEditor_firstName_Context extends AbstractEditorContext<String> {
  private final Person parent;

  public MyEditor_firstName_Context(Person parent, Editor<String> editor, String path) {
    super(editor, path);
    this.parent = parent;
  }
